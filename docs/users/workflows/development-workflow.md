...
\1 init --workspace "$WORKSPACE_DIR"
# Load initial documentation
echo "Loading documentation..."
\1 ingest --workspace "$WORKSPACE_DIR"
# Check status
...
echo "3. Update docs: \1 ingest --workspace ."
```
#### 4.2 Update Script
```bash
#!/bin/bash
...
\1 ingest --workspace . --project documentation
# Update only code documentation
\1 ingest --workspace . --project code-docs
```
...
\1 ingest --workspace . --project documentation --source-type git --source main-docs
