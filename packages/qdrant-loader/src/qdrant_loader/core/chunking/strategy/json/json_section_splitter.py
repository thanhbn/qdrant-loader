...
class JSONSectionSplitter(BaseSectionSplitter):
    ...
    def split_sections(self, content: str, document: Document = None) -> List[Dict[str, Any]]:
    ...
    def _split_large_element(self, element: JSONElement) -> List[JSONElement]:
        ...
        if element.element_type == JSONElementType.ARRAY and isinstance(element.value, list):
        ...
        elif element.element_type == JSONElementType.OBJECT and isinstance(element.value, dict):
    ...
    def merge_small_sections(self, sections: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for section in sections:
            ...
            if (section_size >= self.min_chunk_size or 
                current_size + section_size > self.chunk_size) and current_merged:
            ...
            if current_merged is None:
                ...
                if "metadata" in section:
                    current_merged.setdefault("metadata", {}).update(section["metadata"])
