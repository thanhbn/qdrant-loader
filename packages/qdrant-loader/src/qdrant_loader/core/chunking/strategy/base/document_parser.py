...
class BaseDocumentParser(ABC):
    ...
    def parse_document_structure(self, content: str) -> Dict[str, Any]:
        ...
        """
        raise NotImplementedError("Document parser must implement parse_document_structure method")
    ...
    def extract_section_metadata(self, section: Any) -> Dict[str, Any]:
        ...
        Raises:
            NotImplementedError: If the parser doesn't implement this method
        """
        raise NotImplementedError("Document parser must implement extract_section_metadata method")
