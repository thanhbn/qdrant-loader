...
class BaseSectionSplitter(ABC):
    ...
    def __init__(self, settings: "Settings"):
        ...
        self.max_chunks_per_document = settings.global_config.chunking.max_chunks_per_document
    ...
    def split_sections(self, content: str, document: Optional["Document"] = None) -> List[Dict[str, Any]]:
        ...
        """
        raise NotImplementedError("Section splitter must implement split_sections method")
    ...
    def validate_section_size(self, content: str) -> bool:
        ...
        """
        return len(content) <= self.chunk_size * 2  # Allow up to 2x chunk size for sections
    ...
    def calculate_split_points(self, content: str, target_size: int) -> List[int]:
        ...
        while current_pos < len(content):
            ...
            boundary_pos = self._find_natural_boundary(content, search_start, search_end)
    ...
    def create_section_metadata(self, content: str, index: int, section_type: str = "content") -> Dict[str, Any]:
    ...
    def split_content_by_size(self, content: str, max_size: int) -> List[str]:
        ...
        while start < len(content):
            ...
            if end < len(content):
                boundary_pos = self._find_natural_boundary(content, end - max_size // 4, end)
