...
class BaseMetadataExtractor(ABC):
    ...
    def extract_hierarchical_metadata(self, content: str, chunk_metadata: Dict[str, Any], 
        ...
        """
        raise NotImplementedError("Metadata extractor must implement extract_hierarchical_metadata method")
    ...
    def extract_entities(self, text: str) -> List[str]:
        ...
        Raises:
            NotImplementedError: If the extractor doesn't implement this method
        """
        raise NotImplementedError("Metadata extractor must implement extract_entities method")
    ...
    def extract_cross_references(self, text: str) -> List[Dict[str, Any]]:
        ...
        standalone_pattern = r'(?i)\b(section|chapter|part|appendix)\s+([A-Z0-9]+(?:\.[0-9]+)*)\b'
    ...
    def analyze_content_type(self, content: str) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            "has_headers": bool(re.search(r'^\s*#+\s|^={3,}|^-{3,}', content, re.MULTILINE)),
            "has_links": bool(re.search(r'https?://|www\.|[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}', content)),
        ...
        complexity_score = 0
        if analysis["has_code"]: complexity_score += 2
        if analysis["has_math"]: complexity_score += 2
        if analysis["has_tables"]: complexity_score += 1
        if analysis["has_lists"]: complexity_score += 1
        if analysis["has_headers"]: complexity_score += 1
    ...
    def create_breadcrumb_metadata(self, current_section: str, parent_sections: List[str]) -> Dict[str, Any]:
        ...
        """
        breadcrumb_path = parent_sections + [current_section] if current_section else parent_sections
