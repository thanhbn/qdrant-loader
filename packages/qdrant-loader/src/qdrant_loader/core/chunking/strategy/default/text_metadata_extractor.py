...
class TextMetadataExtractor(BaseMetadataExtractor):
    ...
    def extract_entities(self, text: str) -> List[str]:
        ...
        stop_words = {'The', 'This', 'That', 'These', 'Those', 'When', 'Where', 'Why', 'How', 'What', 'He', 'She', 'It', 'We', 'They', 'I', 'You', 'Dr', 'Mr', 'Ms', 'Mrs'}
        entities = [word for word in capitalized_words if word not in stop_words and len(word) > 2]
    ...
    def _calculate_text_density(self, content: str) -> Dict[str, float]:
        ...
        if total_chars == 0:
            return {"alphanumeric_ratio": 0.0, "whitespace_ratio": 0.0, "punctuation_ratio": 0.0}
    ...
    def _analyze_formatting(self, content: str) -> Dict[str, bool]:
        ...
        return {
            ...
            "has_currency": bool(re.search(r'\$\d+(?:\.\d{2})?|\d+\s?(?:USD|EUR|GBP)', content)),
