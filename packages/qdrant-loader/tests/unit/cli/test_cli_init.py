...
class TestLazyImports:
    ...
    def test_async_ingestion_pipeline_lazy_import(self):
        ...
        with patch(
            "qdrant_loader.core.async_ingestion_pipeline.AsyncIngestionPipeline"
        ) as mock_pipeline:
    ...
    def test_invalid_attribute_raises_attribute_error(self):
        ...
        assert (
            "module 'qdrant_loader.cli' has no attribute 'nonexistent_attribute'"
            in error_message
        )
    ...
    def test_lazy_import_attribute_error_path(self):
        ...
        with pytest.raises(
            AttributeError,
            match="module 'qdrant_loader.cli' has no attribute 'invalid_attribute'",
        ):
            _ = cli_module.invalid_attribute
    ...
    def test_module_has_expected_structure(self):
        ...
        assert callable(cli_module.__getattr__)
