...
class TestGlobalConfig:
    ...
    def test_custom_nested_configs(self):
        ...
        config = GlobalConfig(
            ...
            semantic_analysis=custom_semantic
        )
...
class TestSettings:
    ...
    def test_settings_class_exists(self):
        ...
        config_file = Path(__file__).parent.parent.parent / "src" / "qdrant_loader" / "config.py"
        ...
        for field in expected_fields:
            assert field in annotations, f"Field {field} not found in Settings annotations"
