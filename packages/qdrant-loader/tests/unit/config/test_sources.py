...
class TestSourcesConfig:
    ...
    def test_convert_source_configs_unknown_source_type(self):
        ...
        configs = {"unknown_source": {"url": "https://unknown.example.com"}}
    ...
    def test_convert_source_configs_import_error(self):
        ...
        with patch(
            "qdrant_loader.config.sources._get_connector_config_classes"
        ) as mock_get_classes:
            ...
            configs = {"repo1": {"url": "https://github.com/test/repo.git"}}
    ...
    def test_convert_source_configs_attribute_error(self):
        ...
        with patch(
            ...
            configs = {"wiki1": {"url": "https://confluence.example.com"}}
    ...
    def test_convert_source_configs_type_error(self):
        ...
        with patch(
            ...
            configs = {"project1": {"url": "https://jira.example.com"}}
