...
class TestConfigValidator:
    ...
    def test_validate_projects_section_duplicate_ids(self, validator):
        ...
        projects_data = {
            ...
            "project1": {"display_name": "Project 1 Duplicate"}  # This won't actually create a duplicate in Python dict
        }
    ...
    def test_validate_projects_section_duplicate_collection_names(self, validator):
        ...
        with pytest.raises(ValueError, match="Duplicate collection name 'shared_collection'"):
    ...
    def test_validate_project_config_not_dict(self, validator):
        ...
        with pytest.raises(ValueError, match="Project 'test' configuration must be a dictionary"):
    ...
    def test_validate_project_config_missing_display_name(self, validator):
        ...
        with pytest.raises(ValueError, match="Project 'test' must have a 'display_name'"):
    ...
    def test_validate_project_config_invalid_display_name(self, validator):
        ...
        with pytest.raises(ValueError, match="Project 'test' display_name must be a non-empty string"):
            validator._validate_project_config("test", project_config)
    ...
    def test_validate_project_config_invalid_description(self, validator):
        ...
        with pytest.raises(ValueError, match="Project 'test' description must be a string or null"):
            validator._validate_project_config("test", project_config)
    ...
    def test_validate_project_config_invalid_collection_name(self, validator):
        ...
        with pytest.raises(ValueError, match="Project 'test' collection_name must be a non-empty string"):
            validator._validate_project_config("test", project_config)
    ...
    def test_validate_project_config_invalid_overrides(self, validator):
        ...
        with pytest.raises(ValueError, match="Project 'test' overrides must be a dictionary"):
            validator._validate_project_config("test", project_config)
    ...
    def test_validate_sources_section_invalid_source_config(self, validator):
        ...
        with pytest.raises(ValueError, match="Source 'repo1' in 'git' must be a dictionary"):
            validator._validate_sources_section(sources_data)
    ...
    def test_validate_global_section_invalid_qdrant_collection_name(self, validator):
        ...
        with pytest.raises(ValueError, match="'global.qdrant.collection_name' must be a non-empty string"):
            validator._validate_global_section(global_data)

    def test_validate_global_section_invalid_qdrant_collection_name_type(self, validator):
    ...
    def test_validate_source_config_not_dict(self, validator):
        ...
        with pytest.raises(ValueError, match="Source 'test' of type 'git' configuration must be a dictionary"):
    ...
    def test_validate_source_config_empty(self, validator):
        ...
        with pytest.raises(ValueError, match="Source 'test' of type 'git' configuration cannot be empty"):
    ...
    def test_validate_source_config_valid(self, validator):
        ...
        validator._validate_source_config("git", "test", source_config)  # Should not raise
    ...
    def test_validate_collection_name_valid(self, validator):
        ...
        valid_names = ["collection1", "my_collection", "test-collection", "CollectionABC"]
