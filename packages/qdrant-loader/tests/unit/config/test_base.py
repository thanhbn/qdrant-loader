...
class TestConfigProtocol:
    ...
    def test_config_protocol_structure(self):
        ...
        assert get_origin(ConfigProtocol) is not None or hasattr(
            ConfigProtocol, "_is_protocol"
        )
...
class TestSourceConfigProtocol:
    ...
    def test_source_config_protocol_structure(self):
        ...
        assert get_origin(SourceConfigProtocol) is not None or hasattr(
            SourceConfigProtocol, "_is_protocol"
        )
