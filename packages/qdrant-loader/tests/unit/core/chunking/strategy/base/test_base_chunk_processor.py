...
class TestBaseChunkProcessor:
    ...
    def test_create_base_chunk_metadata_preserves_original(self, processor, sample_document):
    ...
    def test_concrete_implementation_create_chunk_document(self, processor, sample_document):
