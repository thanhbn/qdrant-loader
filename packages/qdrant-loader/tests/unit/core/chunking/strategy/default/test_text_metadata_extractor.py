...
import pytest
from qdrant_loader.core.chunking.strategy.default.text_metadata_extractor import TextMetadataExtractor
...
class TestTextMetadataExtractor:
    ...
    def test_extract_hierarchical_metadata_basic(self, extractor, sample_document):
        ...
        result = extractor.extract_hierarchical_metadata(content, chunk_metadata, sample_document)
    ...
    def test_extract_hierarchical_metadata_empty_content(self, extractor, sample_document):
    ...
    def test_preserves_original_metadata(self, extractor, sample_document):
        ...
        result = extractor.extract_hierarchical_metadata(content, original_metadata, sample_document)
    ...
    def test_metadata_structure(self, extractor, sample_document):
        ...
        # Check required keys
        required_keys = [
            "word_count", "character_count", "paragraph_count", "sentence_count",
            "avg_word_length", "reading_time_minutes", "content_type", "language",
            "text_density", "formatting_indicators"
        ]
