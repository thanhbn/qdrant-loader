...
class TestJSONChunkProcessor:
    ...
    def test_init(self):
        ...
        assert self.processor.json_config is self.mock_settings.global_config.chunking.strategies.json_strategy
    ...
    def test_create_chunk_document_basic(self):
        ...
        with patch.object(self.processor, '_should_skip_nlp_for_json', return_value=False):
            with patch.object(self.processor, '_create_enhanced_metadata', return_value={"enhanced": "metadata"}):
    ...
    def test_create_chunk_document_with_skip_nlp(self):
        ...
        with patch.object(self.processor, '_should_skip_nlp_for_json', return_value=True):
            with patch.object(self.processor, '_create_enhanced_metadata', return_value={"enhanced": "metadata"}):
                result = self.processor.create_chunk_document(
                    self.test_doc,
                    chunk_content,
    ...
    def test_should_skip_nlp_for_json_data_types(self):
        ...
        metadata = {
            "json_type": "list",
            "structure_type": "primitive_collection"
        }
    ...
    def test_should_skip_nlp_for_json_minimal_text(self):
        ...
        with patch.object(self.processor, '_is_minimal_text_content', return_value=True):
            result = self.processor._should_skip_nlp_for_json(content, metadata)
    ...
    def test_should_skip_nlp_for_json_configuration_structure(self):
        ...
        with patch.object(self.processor, '_is_minimal_text_content', return_value=False):
            with patch.object(self.processor, '_is_configuration_structure', return_value=True):
                result = self.processor._should_skip_nlp_for_json(content, metadata)
    ...
    def test_should_skip_nlp_for_json_normal_content(self):
        ...
        content = '{"description": "This is a long description with natural language text."}'
        metadata = {"json_type": "object"}
        
        with patch.object(self.processor, '_is_minimal_text_content', return_value=False):
            with patch.object(self.processor, '_is_configuration_structure', return_value=False):
                result = self.processor._should_skip_nlp_for_json(content, metadata)
    ...
    def test_is_configuration_structure_multiple_indicators(self):
        ...
        metadata = {
            "configuration_indicators": ["setting1", "setting2", "setting3"]
        }
    ...
    def test_is_configuration_structure_schema_patterns(self):
        ...
        metadata = {
            "schema_patterns": ["configuration_object", "other_pattern"]
        }
    ...
    def test_is_configuration_structure_typed_value_pattern(self):
        ...
        metadata = {
            "schema_patterns": ["typed_value", "unrelated_pattern"]
        }
    ...
    def test_create_enhanced_metadata(self):
        ...
        assert result["supports_schema_inference"] == self.processor.json_config.enable_schema_inference
