...
from qdrant_loader.core.chunking.strategy.code.code_metadata_extractor import (
...
'''
        ...
        assert (
            "connect" in entities
            or "disconnect" in entities
            or "calculate_average" in entities
        )
...
"""
        ...
        metadata = self.extractor._extract_language_specific_metadata(
            python_code, "python"
        )
