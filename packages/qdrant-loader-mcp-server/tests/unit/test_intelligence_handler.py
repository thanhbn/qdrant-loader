...
class TestIntelligenceHandlerAnalyzeRelationships:
    ...
    @pytest.mark.asyncio
    async def test_handle_analyze_document_relationships_success(
        ...
        mock_search_engine.analyze_document_relationships.return_value = (
            mock_analysis_result
        )
        ...
        result = await intelligence_handler.handle_analyze_document_relationships(
            1, params
        )

        # Verify search engine was called correctly
        mock_search_engine.analyze_document_relationships.assert_called_once_with(
            query="test query", limit=20, project_ids=None, source_types=None
        )
    ...
    @pytest.mark.asyncio
    async def test_handle_analyze_document_relationships_with_filters(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_analyze_document_relationships_missing_query(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_analyze_document_relationships_engine_error(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test error handling when search engine fails."""
        # Mock search engine to raise an exception
        mock_search_engine.analyze_document_relationships.side_effect = Exception(
            "Analysis failed"
        )
...
class TestIntelligenceHandlerFindSimilar:
    ...
    @pytest.mark.asyncio
    async def test_handle_find_similar_documents_success(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_find_similar_documents_with_metrics(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
...
class TestIntelligenceHandlerDetectConflicts:
    ...
    @pytest.mark.asyncio
    async def test_handle_detect_document_conflicts_success(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        params = {"query": "conflict query", "limit": 25}
        ...
        mock_search_engine.detect_document_conflicts.assert_called_once_with(
            query="conflict query", limit=25, project_ids=None, source_types=None
        )
...
class TestIntelligenceHandlerFindComplementary:
    ...
    @pytest.mark.asyncio
    async def test_handle_find_complementary_content_success(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
...
class TestIntelligenceHandlerClusterDocuments:
    ...
    @pytest.mark.asyncio
    async def test_handle_cluster_documents_success(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        params = {"query": "clustering query", "max_clusters": 5, "min_cluster_size": 3}
    ...
    @pytest.mark.asyncio
    async def test_handle_cluster_documents_with_strategy(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        params = {"query": "strategy test", "strategy": "hierarchical", "limit": 30}
...
class TestIntelligenceHandlerEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_find_similar_missing_target_query(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_complementary_missing_context_query(
        self, intelligence_handler, mock_protocol
    ):
        ...
        result = await intelligence_handler.handle_find_complementary_content(
            12, params
        )
    ...
    @pytest.mark.asyncio
    async def test_detect_conflicts_missing_query(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_cluster_documents_missing_query(
        self, intelligence_handler, mock_protocol
    ):
...
class TestIntelligenceHandlerExpandCluster:
    ...
    @pytest.mark.asyncio
    async def test_handle_expand_cluster_success(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_expand_cluster_with_pagination(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_expand_cluster_missing_cluster_id(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_expand_cluster_with_exception(
        self, intelligence_handler, mock_protocol
    ):
...
class TestIntelligenceHandlerComplexDataProcessing:
    ...
    @pytest.mark.asyncio
    async def test_analyze_relationships_with_document_clusters(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        await intelligence_handler.handle_analyze_document_relationships(19, params)
    ...
    @pytest.mark.asyncio
    async def test_analyze_relationships_with_conflicts(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        await intelligence_handler.handle_analyze_document_relationships(20, params)
        ...
        conflict_relationships = [
            r
            for r in response_data["relationships"]
    ...
    @pytest.mark.asyncio
    async def test_analyze_relationships_with_complementary_content(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        complementary_analysis_result = {
            ...
            "complementary_content": {"doc1": mock_complementary_obj},
        }
        ...
        await intelligence_handler.handle_analyze_document_relationships(21, params)
    ...
    @pytest.mark.asyncio
    async def test_analyze_relationships_with_citation_network(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test processing of citation networks in relationship analysis."""
        citation_analysis_result = {
            "query_metadata": {"document_count": 30},
            "citation_network": {"edges": 15, "nodes": 10},
            "similarity_insights": [{"pattern": "cross_referencing", "strength": 0.7}],
        }
        ...
        await intelligence_handler.handle_analyze_document_relationships(22, params)
    ...
    @pytest.mark.asyncio
    async def test_analyze_relationships_empty_results(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test handling of empty analysis results."""
        empty_analysis_result = {"query_metadata": {"document_count": 5}}
        ...
        await intelligence_handler.handle_analyze_document_relationships(23, params)
    ...
    @pytest.mark.asyncio
    async def test_analyze_relationships_malformed_conflict_data(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        await intelligence_handler.handle_analyze_document_relationships(24, params)
...
class TestIntelligenceHandlerErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_find_similar_documents_search_engine_error(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test error handling when search engine fails in find_similar_documents."""
        mock_search_engine.find_similar_documents.side_effect = Exception(
        ...
        params = {"target_query": "test target", "comparison_query": "test comparison"}
    ...
    @pytest.mark.asyncio
    async def test_detect_conflicts_search_engine_error(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test error handling when search engine fails in detect_document_conflicts."""
        mock_search_engine.detect_document_conflicts.side_effect = RuntimeError(
    ...
    @pytest.mark.asyncio
    async def test_find_complementary_content_search_engine_error(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test error handling when search engine fails in find_complementary_content."""
        mock_search_engine.find_complementary_content.side_effect = ValueError(
        ...
        params = {"target_query": "target test", "context_query": "context test"}
    ...
    @pytest.mark.asyncio
    async def test_cluster_documents_search_engine_error(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test error handling when search engine fails in cluster_documents."""
        mock_search_engine.cluster_documents.side_effect = ConnectionError(
            "Connection timeout"
        )
        mock_error_response = {
            "error": {"code": -32603, "message": "Internal server error"}
    ...
    @pytest.mark.asyncio
    async def test_expand_cluster_internal_error(
        self, intelligence_handler, mock_protocol
    ):
        ...
        await intelligence_handler.handle_expand_cluster(29, params)
...
class TestIntelligenceHandlerParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_find_similar_documents_missing_comparison_query(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_similar_documents_missing_both_queries(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_complementary_content_missing_target_query(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_complementary_content_missing_both_queries(
        self, intelligence_handler, mock_protocol
    ):
    ...
    @pytest.mark.asyncio
    async def test_empty_parameters_all_methods(
        self, intelligence_handler, mock_protocol
    ):
...
class TestIntelligenceHandlerResponseFormatting:
    ...
    @pytest.mark.asyncio
    async def test_response_structure_formatting(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        mock_response = {
            "result": {
                "content": [{"type": "text", "text": "Formatted analysis text"}],
                "structuredContent": {
                    "relationships": [],
                    "total_analyzed": 10,
    ...
    @pytest.mark.asyncio
    async def test_find_similar_documents_formatting_validation(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        with patch(
            "qdrant_loader_mcp_server.mcp.intelligence_handler.logger"
        ) as mock_logger:
            await intelligence_handler.handle_find_similar_documents(41, params)
    ...
    async def test_formatter_method_calls(
        ...
        with (
            patch.object(
                intelligence_handler.formatters, "format_relationship_analysis"
            ) as mock_format_rel,
            patch.object(
                intelligence_handler.formatters, "format_similar_documents"
            ) as mock_format_sim,
            patch.object(
                intelligence_handler.formatters, "format_conflict_analysis"
            ) as mock_format_conf,
            patch.object(
                intelligence_handler.formatters, "format_complementary_content"
            ) as mock_format_comp,
            patch.object(
                intelligence_handler.formatters, "format_document_clusters"
            ) as mock_format_clust,
        ):
            ...
            mock_search_engine.detect_document_conflicts.return_value = {
                "original_documents": []
            }
            ...
            await intelligence_handler.handle_analyze_document_relationships(
                42, {"query": "test"}
            )
            mock_format_rel.assert_called_once()

            await intelligence_handler.handle_find_similar_documents(
                43, {"target_query": "t", "comparison_query": "c"}
            )
            mock_format_sim.assert_called_once()

            await intelligence_handler.handle_detect_document_conflicts(
                44, {"query": "test"}
            )
            mock_format_conf.assert_called_once()

            await intelligence_handler.handle_find_complementary_content(
                45, {"target_query": "t", "context_query": "c"}
            )
    ...
    @pytest.mark.asyncio
    async def test_structured_content_creation_calls(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        with (
            patch.object(
                intelligence_handler.formatters,
                "create_lightweight_similar_documents_results",
            ) as mock_create_sim,
            patch.object(
                intelligence_handler.formatters, "create_lightweight_conflict_results"
            ) as mock_create_conf,
            patch.object(
                intelligence_handler.formatters,
                "create_lightweight_complementary_results",
            ) as mock_create_comp,
            patch.object(
                intelligence_handler.formatters, "create_lightweight_cluster_results"
            ) as mock_create_clust,
        ):
            ...
            await intelligence_handler.handle_find_similar_documents(
                47, {"target_query": "t", "comparison_query": "c"}
            )
            ...
            await intelligence_handler.handle_find_complementary_content(
                49, {"target_query": "t", "context_query": "c"}
            )
...
class TestIntelligenceHandlerEdgeCasesMalformedData:
    ...
    @pytest.mark.asyncio
    async def test_complementary_content_list_instead_of_object(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        await intelligence_handler.handle_analyze_document_relationships(51, params)
    ...
    @pytest.mark.asyncio
    async def test_malformed_document_clusters_missing_documents(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
            ...
            "document_clusters": [
                {
                    ...
                    "cohesion_score": 0.9,
                    "documents": [{"document_id": "doc1", "title": "Doc 1"}],
                },
                {
        ...
        await intelligence_handler.handle_analyze_document_relationships(52, params)
    ...
    @pytest.mark.asyncio
    async def test_documents_missing_ids_and_titles(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        await intelligence_handler.handle_analyze_document_relationships(53, params)
    ...
    @pytest.mark.asyncio
    async def test_find_similar_documents_count_validation(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        with patch(
            ...
            await intelligence_handler.handle_find_similar_documents(54, params)
    ...
    @pytest.mark.asyncio
    async def test_empty_query_strings(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        """Test handling of empty query strings."""
        mock_search_engine.analyze_document_relationships.return_value = {
            "query_metadata": {"document_count": 0}
        }
        mock_protocol.create_response.return_value = {"result": "success"}

        # Test with empty string query
        params = {"query": ""}
        await intelligence_handler.handle_analyze_document_relationships(55, params)

        # Should handle empty query gracefully
        mock_search_engine.analyze_document_relationships.assert_called_once_with(
            query="", limit=20, source_types=None, project_ids=None
        )

    @pytest.mark.asyncio
    async def test_none_values_in_params(
        self, intelligence_handler, mock_search_engine, mock_protocol
    ):
        ...
        await intelligence_handler.handle_find_similar_documents(56, params)
