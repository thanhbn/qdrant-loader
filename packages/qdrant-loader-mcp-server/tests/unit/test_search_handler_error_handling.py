...
class TestSearchErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_handle_search_query_processor_timeout(
        self, search_handler_with_mocks
    ):
        ...
        await search_handler_with_mocks.handle_search(1, params)
        ...
        search_handler_with_mocks.protocol.create_response.assert_called_once_with(
            ...
            error={
                ...
                "data": "OpenAI request timed out",
            },
        )

    @pytest.mark.asyncio
    async def test_handle_search_search_engine_connection_error(
        self, search_handler_with_mocks
    ):
        """Test search when search engine has connection issues."""
        search_handler_with_mocks.query_processor.process_query.return_value = {
            "query": "test"
        }
        ...
        search_handler_with_mocks.protocol.create_response.assert_called_once_with(
            ...
            error={
                "code": -32603,
                "message": "Internal error",
                "data": "Qdrant connection refused",
            },
        )

    @pytest.mark.asyncio
    async def test_handle_search_invalid_response_from_engine(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            search_handler_with_mocks.formatters, "create_structured_search_results"
        ) as mock_structured:
    ...
    @pytest.mark.asyncio
    async def test_handle_search_malformed_query_params(
        self, search_handler_with_mocks
    ):
    ...
    async def test_handle_search_empty_query_string(self, search_handler_with_mocks):
        ...
        with patch.object(
            ...
            with patch.object(
                search_handler_with_mocks.formatters, "format_search_result"
            ):
                params = {"query": ""}
                await search_handler_with_mocks.handle_search(1, params)
        ...
        with patch.object(
            ...
            with patch.object(
                ...
                search_handler_with_mocks.search_engine.search.assert_called_once_with(
                    query="test", source_types=[], project_ids=[], limit=999999
                )
...
class TestHierarchySearchErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_handle_hierarchy_search_filter_processing_error(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            search_handler_with_mocks, "_apply_hierarchy_filters"
        ) as mock_filter:
            mock_filter.side_effect = ValueError("Invalid hierarchy filter")

            params = {"query": "test", "hierarchy_filter": {"invalid": "filter"}}
            await search_handler_with_mocks.handle_hierarchy_search(1, params)
            ...
            search_handler_with_mocks.protocol.create_response.assert_called_once_with(
                ...
                error={
                    "code": -32603,
                    "message": "Internal error",
                    "data": "Invalid hierarchy filter",
                },
            )

    @pytest.mark.asyncio
    async def test_handle_hierarchy_search_organization_error(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            search_handler_with_mocks, "_organize_by_hierarchy"
        ) as mock_organize:
            ...
            search_handler_with_mocks.protocol.create_response.assert_called_once_with(
                ...
                error={
                    "code": -32603,
                    "message": "Internal error",
                    "data": "'Missing hierarchy attribute'",
                },
            )

    @pytest.mark.asyncio
    async def test_handle_hierarchy_search_malformed_hierarchy_filter(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            search_handler_with_mocks.formatters, "create_lightweight_hierarchy_results"
        ):
...
class TestAttachmentSearchErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_handle_attachment_search_filter_error(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            search_handler_with_mocks, "_apply_lightweight_attachment_filters"
        ) as mock_filter:
            mock_filter.side_effect = AttributeError(
                "'Mock' object has no attribute 'file_size'"
            )

            params = {"query": "test", "attachment_filter": {"file_size_min": 1000}}
            await search_handler_with_mocks.handle_attachment_search(1, params)
            ...
            search_handler_with_mocks.protocol.create_response.assert_called_once_with(
                ...
                error={
                    "code": -32603,
                    "message": "Internal error",
                    "data": "'Mock' object has no attribute 'file_size'",
                },
            )

    @pytest.mark.asyncio
    async def test_handle_attachment_search_organization_error(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            search_handler_with_mocks.formatters, "_organize_attachments_by_type"
        ) as mock_organize:
...
class TestExpandDocumentErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_handle_expand_document_search_engine_error(
        self, search_handler_with_mocks
    ):
        """Test document expansion when search engine fails."""
        search_handler_with_mocks.search_engine.search.side_effect = RuntimeError(
        ...
        await search_handler_with_mocks.handle_expand_document(1, params)
        ...
        search_handler_with_mocks.protocol.create_response.assert_called_once_with(
            ...
            error={
                "code": -32603,
                "message": "Internal error",
                "data": "Search index corrupted",
            },
        )

    @pytest.mark.asyncio
    async def test_handle_expand_document_partial_match_error(
        self, search_handler_with_mocks
    ):
        ...
        search_handler_with_mocks.protocol.create_response.assert_called_once_with(
            ...
            error={
                "code": -32603,
                "message": "Internal error",
                "data": "General search failed",
            },
        )

    @pytest.mark.asyncio
    async def test_handle_expand_document_invalid_document_id(
        self, search_handler_with_mocks
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_expand_document_formatting_error(
        self, search_handler_with_mocks
    ):
        ...
        with patch.object(
            ...
            search_handler_with_mocks.protocol.create_response.assert_called_once_with(
                ...
                error={
                    "code": -32603,
                    "message": "Internal error",
                    "data": "Cannot format malformed result",
                },
            )
...
class TestFilterErrorHandling:
    ...
    def test_apply_hierarchy_filters_malformed_results(self, search_handler_with_mocks):
        ...
        try:
            filtered = search_handler_with_mocks._apply_hierarchy_filters(
                [malformed_result], hierarchy_filter
            )
    ...
    def test_apply_hierarchy_filters_invalid_filter_values(
        self, search_handler_with_mocks
    ):
    ...
    def test_apply_lightweight_attachment_filters_corrupted_results(
        self, search_handler_with_mocks
    ):
        ...
        try:
            filtered = search_handler_with_mocks._apply_lightweight_attachment_filters(
                [corrupted_result], attachment_filter
            )
            assert isinstance(filtered, list)
    ...
    def test_organize_by_hierarchy_missing_attributes(self, search_handler_with_mocks):
        ...
        try:
            organized = search_handler_with_mocks._organize_by_hierarchy(
                [incomplete_result]
            )
...
class TestFormattingErrorHandling:
    ...
    def test_format_lightweight_attachment_text_invalid_data(
        self, search_handler_with_mocks
    ):
        ...
        try:
            result = search_handler_with_mocks._format_lightweight_attachment_text(
                invalid_organized, 5
            )
    ...
    def test_format_lightweight_hierarchy_text_invalid_data(
        self, search_handler_with_mocks
    ):
        ...
        try:
            result = search_handler_with_mocks._format_lightweight_hierarchy_text(
                invalid_organized, 3
            )
            assert isinstance(result, str)
        except (TypeError, AttributeError):
    ...
    def test_formatting_with_unicode_content(self, search_handler_with_mocks):
        ...
        unicode_organized = {
            "📁 Special Group 🔥": [Mock(source_title="测试文档", score=0.9)]
        }
        ...
        result2 = search_handler_with_mocks._format_lightweight_hierarchy_text(
            unicode_organized, 1
        )
