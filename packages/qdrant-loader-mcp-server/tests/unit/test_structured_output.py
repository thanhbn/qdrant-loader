...
class TestStructuredOutputFormat:
    ...
    @pytest.mark.asyncio
    async def test_search_returns_structured_content(
        self,
        mcp_handler,
    ...
    @pytest.mark.asyncio
    async def test_structured_content_schema_compliance(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
    ...
    @pytest.mark.asyncio
    async def test_query_context_in_structured_output(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
    ...
    @pytest.mark.asyncio
    async def test_total_found_accuracy(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
...
class TestBackwardCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_text_content_still_provided(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
    ...
    @pytest.mark.asyncio
    async def test_text_content_includes_search_results(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
...
class TestStructuredOutputTypes:
    ...
    @pytest.mark.asyncio
    async def test_numeric_scores_are_numbers(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
    ...
    @pytest.mark.asyncio
    async def test_arrays_and_objects_structure(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
        ...
        assert isinstance(
            structured_content["query_context"]["source_types_filtered"], list
        )
...
class TestStructuredOutputErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_empty_results_structured_output(
    ...
    @pytest.mark.asyncio
    async def test_structured_output_with_missing_metadata(
        self, mcp_handler, mock_query_processor, mock_search_engine
    ):
...
class TestStructuredOutputConsistency:
    ...
    @pytest.mark.asyncio
    async def test_result_count_consistency(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
    ...
    @pytest.mark.asyncio
    async def test_query_parameter_consistency(
        self,
        mcp_handler,
        mock_query_processor,
        mock_search_engine,
