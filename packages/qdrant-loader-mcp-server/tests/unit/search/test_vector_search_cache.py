...
from qdrant_loader_mcp_server.search.components.vector_search_service import VectorSearchService
...
class TestVectorSearchCache:
    ...
    def test_cache_key_generation(self, vector_search_service):
        ...
        key6 = vector_search_service._generate_cache_key("test query", 10, ["project1", "project2"])
        key7 = vector_search_service._generate_cache_key("test query", 10, ["project2", "project1"])
        assert key6 == key7

    def test_cache_initialization(self, vector_search_service, vector_search_service_no_cache):
    ...
    async def test_cache_disabled(self, vector_search_service_no_cache, sample_search_results):
        ...
        # Mock the get_embedding method
        vector_search_service_no_cache.get_embedding = AsyncMock(return_value=[0.1, 0.2, 0.3])
        
        # Mock QDrant search response
        vector_search_service_no_cache.qdrant_client.search.return_value = sample_search_results
    ...
    def test_cache_cleanup_expired_entries(self, vector_search_service):
        ...
        with patch('qdrant_loader_mcp_server.search.components.vector_search_service.time.time') as mock_time:
            # Add some cache entries at different times
            mock_time.return_value = 1000.0
            vector_search_service._search_cache["key1"] = {"results": [], "timestamp": 1000.0}
            vector_search_service._search_cache["key2"] = {"results": [], "timestamp": 1100.0}
    ...
    def test_cache_size_limit(self, vector_search_service):
        ...
        with patch('qdrant_loader_mcp_server.search.components.vector_search_service.time.time') as mock_time:
            ...
            vector_search_service._search_cache["key1"] = {"results": [], "timestamp": 1000.0}
            vector_search_service._search_cache["key2"] = {"results": [], "timestamp": 1001.0}
            vector_search_service._search_cache["key3"] = {"results": [], "timestamp": 1002.0}
    ...
    def test_cache_stats(self, vector_search_service):
        ...
        vector_search_service._search_cache["test"] = {"results": [], "timestamp": time.time()}
    ...
    def test_clear_cache(self, vector_search_service):
        ...
        vector_search_service._search_cache["key1"] = {"results": [], "timestamp": time.time()}
        vector_search_service._search_cache["key2"] = {"results": [], "timestamp": time.time()}
    ...
    async def test_project_filter_caching(self, vector_search_service, sample_search_results):
        ...
        await vector_search_service.vector_search("test query", 10, ["project1"])  # Should hit cache
