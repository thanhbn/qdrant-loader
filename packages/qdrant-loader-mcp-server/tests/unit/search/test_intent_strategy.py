...
from qdrant_loader_mcp_server.search.enhanced.intent.strategy import AdaptiveSearchStrategy
...
class TestAdaptiveSearchStrategy:
    ...
    def test_business_context_config(self):
        ...
        search_intent = SearchIntent(
            intent_type=IntentType.BUSINESS_CONTEXT,
            confidence=0.7
        )
    ...
    def test_query_length_adaptations(self):
        ...
        # Long query
        long_query = "How do I configure the API endpoints for authentication with OAuth2"
        long_config = strategy.adapt_search(search_intent, long_query)
        
        # Short queries should have more expansion
        assert short_config.expansion_aggressiveness >= long_config.expansion_aggressiveness
