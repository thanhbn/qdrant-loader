...
def spacy_analyzer(mock_spacy_nlp):
    ...
    with patch('qdrant_loader_mcp_server.search.nlp.spacy_analyzer.spacy.load') as mock_load:
...
class TestSpaCyQueryAnalyzer:
    ...
    def test_analyze_query_semantic_question_detection(self, spacy_analyzer):
        ...
        question_result = spacy_analyzer.analyze_query_semantic("What is API authentication?")
        statement_result = spacy_analyzer.analyze_query_semantic("API authentication implementation")
    ...
    def test_analyze_query_semantic_technical_detection(self, spacy_analyzer):
        ...
        technical_result = spacy_analyzer.analyze_query_semantic("database performance optimization API")
        non_technical_result = spacy_analyzer.analyze_query_semantic("meeting agenda for next week")
    ...
    def test_analyze_query_semantic_intent_classification(self, spacy_analyzer):
        ...
        result = spacy_analyzer.analyze_query_semantic("How to implement authentication?")
