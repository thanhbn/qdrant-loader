...
class TestDocumentSimilarityCalculatorHelpers:
    ...
    def test_calculate_content_features_similarity(self, similarity_calculator):
        ...
        similarity = similarity_calculator._calculate_content_features_similarity(doc1, doc2)
        
        assert 0.0 <= similarity <= 1.0
        assert similarity > 0.0  # Should have some similarity due to similar features

    def test_calculate_content_features_similarity_different_features(self, similarity_calculator):
    ...
    def test_calculate_content_features_similarity_none_values(self, similarity_calculator):
    ...
    def test_calculate_hierarchical_similarity(self, similarity_calculator):
        ...
        similarity = similarity_calculator._calculate_hierarchical_similarity(parent_doc, child_doc)
    ...
    def test_calculate_hierarchical_similarity_siblings(self, similarity_calculator):
        ...
        similarity = similarity_calculator._calculate_hierarchical_similarity(sibling1, sibling2)
    ...
    def test_calculate_hierarchical_similarity_unrelated(self, similarity_calculator):
        ...
        similarity = similarity_calculator._calculate_hierarchical_similarity(doc1, doc2)
...
class TestDocumentClusterAnalyzerHelpers:
    ...
    def test_generate_primary_theme_content_based(self, cluster_analyzer):
        ...
        theme = cluster_analyzer._generate_primary_theme(cluster, common_words, Counter())
    ...
    def test_generate_document_insights(self, cluster_analyzer):
        ...
        insights = cluster_analyzer._generate_document_insights(cluster_docs, source_types)
...
class TestConflictDetectorHelpers:
    ...
    def test_describe_conflict(self, conflict_detector):
        ...
        indicators = ["version conflict", "incompatible versions", "different requirements"]
        
        description = conflict_detector._describe_conflict(indicators)
        
        assert isinstance(description, str)
        assert len(description) > 0
        assert ("version" in description.lower() or 
                "incompatible" in description.lower() or
                "different" in description.lower())
...
class TestComplementaryContentFinderHelpers:
    ...
    def test_has_shared_technologies(self, complementary_finder):
        ...
        doc1 = create_hybrid_search_result(
            ...
            entities=[{"text": "React", "label": "TECH"}, {"text": "Node.js", "label": "TECH"}]
        )
        ...
        doc2 = create_hybrid_search_result(
            ...
            entities=[{"text": "Node.js", "label": "TECH"}, {"text": "Express", "label": "TECH"}]
        )
        ...
        doc3 = create_hybrid_search_result(
            ...
            entities=[{"text": "Python", "label": "TECH"}, {"text": "Django", "label": "TECH"}]
        )
    ...
    def test_has_different_content_complexity(self, complementary_finder):
        ...
        different_complexity = complementary_finder._has_different_content_complexity(simple_doc, complex_doc)
        ...
        same_complexity = complementary_finder._has_different_content_complexity(simple_doc, similar_doc)
    ...
    def test_get_complementary_content_type_score(self, complementary_finder):
        ...
        score = complementary_finder._get_complementary_content_type_score(tutorial_doc, reference_doc)
