...
class DefaultConflictDetector(ConflictDetector):
    ...
    def __init__(self, spacy_analyzer, qdrant_client=None, openai_client=None, collection_name: str = "documents"):
        from ...cross_document_intelligence import ConflictDetector as LegacyConflictDetector  # type: ignore
