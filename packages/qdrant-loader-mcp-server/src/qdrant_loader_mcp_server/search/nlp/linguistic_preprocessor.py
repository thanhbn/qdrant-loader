...
class LinguisticPreprocessor:
    ...
    def __init__(self, spacy_analyzer: SpaCyQueryAnalyzer):
        ...
        self.custom_stopwords = {
            "find", "show", "give", "tell", "search", "look", "get", "want", "need",
            "please", "help", "can", "could", "would", "should", "may", "might",
            "also", "just", "really", "very", "quite", "rather", "pretty", "much"
        }
        ...
        self.preserve_terms = {
            ...
            "crud", "rest", "restful", "graphql", "json", "xml", "yaml",
    ...
    def preprocess_query(
        ...
        try:
            ...
            filtered_tokens, removed_stopwords = self._filter_stopwords(lemmatized_tokens, doc)
            ...
            if preserve_structure:
                preprocessed_query = self._rebuild_structured_query(normalized_tokens, doc)
            else:
    ...
    def _normalize_tokens(self, filtered_tokens: List[str]) -> List[str]:
        ...
        for token in filtered_tokens:
            ...
            if (self.min_token_length <= len(normalized_token) <= self.max_token_length and
                normalized_token.isalpha()):
                normalized.append(normalized_token)
        
        return normalized
    
    def _rebuild_structured_query(
        self, 
        normalized_tokens: List[str], 
        doc
    ) -> str:
